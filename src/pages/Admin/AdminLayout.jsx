...
const LINKS = [
  ...
  { to: '/admin/empleos', label: 'Empleos' },
  { to: '/admin/categorias-empleos', label: 'Categ. empleos' },
  { to: '/admin/eventos', label: 'Eventos' },
  { to: '/admin/categorias-eventos', label: 'Categ. eventos' },
  { to: '/admin/promociones', label: 'Promociones' },
  { to: '/admin/viajes', label: 'Viajes' },
  { to: '/admin/comisiones', label: 'Comisiones' },
  { to: '/admin/destinos', label: 'Destinos' },
